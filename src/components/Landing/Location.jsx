...
const Location = ({ onCheckin, getprofile }) => {
  ...
  const locations = [
    ...
    { id: 13, name: "หญิงใหญ่ หมูกระทะ", top: { pc: "30%", mobile: "38%" }, left: { pc: "60%", mobile: "56%" }, image: "images/pin14.png" },
    { id: 14, name: "พลาญชัย บาร์บีคิว", top: { pc: "75%", mobile: "44%" }, left: { pc: "55%", mobile: "12%" }, image: "images/pin13.png" },
    { id: 15, name: "เจริญพร หมูกระทะแคมป์ปิ้ง", top: { pc: "48%", mobile: "48%" }, left: { pc: "34%", mobile: "34%" }, image: "images/pin15.png" },
  ];
      ...
      <div className={`text-center px-2 w-[100%] mb-auto block gap-2 ${customerinfo ? 'mt-10' : 'mt-25'} lg:mt-40`}>
        <h2 className="text-white font-bold text-lg lg:text-3xl lg:pb-3">
          {customerinfo ?
            ...
            :
            <p className="lg:hidden">เชคพ้อยท์ร้านหมูกระทะ <span className="text-white italic text-3xl font-extrabold drop-shadow-[4px_2px_0px_black] lg:hidden">100 คนแรก</span>
            </p>}
        </h2>
        {!customerinfo && (
