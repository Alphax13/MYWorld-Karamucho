...
const Event = () => {
  return (
    <div className="w-full relative mb-10">
      ...
      <div className="absolute -10 top-[32%] lg:top-[40%] right-[15%] md:right-[23%] lg:right-[15%] xl:right-[38%] flex flex-col items-center transform -translate-y-1/2">
        <h1 className="text-base lg:text-xl font-bold">ล่า COINS หมูกะทะ</h1>
      </div>
      {/* Container ปุ่ม ใช้ absolute กำหนดตำแหน่ง + responsive */}
      <div className="absolute -10 top-[68%] right-[15%] md:right-[20%] lg:right-[20%] xl:right-[38%] flex flex-col items-center gap-35 md:gap-60 lg:gap-50 xl:gap-75 transform -translate-y-1/2">
